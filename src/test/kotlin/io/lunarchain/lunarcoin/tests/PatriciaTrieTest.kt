...
class PatriciaTrieTest {
    ...
    fun testTrieNodeEncodeDecode() {
        ...
        val leafNode = TrieNode(
            arrayOf(0x20.toByte(), 0x01.toByte(), 0x01.toByte(), 0x02.toByte()).toByteArray(),
        ...
        val extensionNode = TrieNode(
            arrayOf(0x01.toByte(), 0x01.toByte(), 0x01.toByte(), 0x02.toByte()).toByteArray(),
            EMPTY_VALUE, null
        )
        ...
        val branchNode = TrieNode(
            EMPTY_VALUE, "hello".toByteArray(),
            arrayOf(
                EMPTY_VALUE, "234".toByteArray(), "3233".toByteArray(), EMPTY_VALUE, EMPTY_VALUE,
